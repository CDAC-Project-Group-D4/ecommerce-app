...
function Wishlist() {
    ...
    return (
        <div style={{ backgroundColor: "#FAFAFA", minHeight: "100vh" }}>
            <div className="wishlist-header text-center mb-4">
            ...
            <div className="container pb-5">
                ...
                {!loading && wishlistItems.length === 0 && !error && (
                    <div className="text-center py-5">
                        ...
                        <p className="text-muted">Tap the heart icon on a product to save it here.</p>
                    </div>
                )}
                                    ...
                                    <div className="card-body d-flex align-items-center gap-3">
                                        ...
                                        <div className="flex-grow-1">
                                            ...
                                            <div className="d-flex align-items-center gap-2">
                                                ...
                                                {item.inStock ? (
                                                    <span className="badge rounded-pill badge-in-stock">In Stock</span>
                                                ) : (
                                                    <span className="badge rounded-pill badge-out-stock">Out of Stock</span>
                                                )}
                                            </div>
                                        </div>
