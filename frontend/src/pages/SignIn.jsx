      ...
      <div className="auth-wrapper d-flex shadow">
        ...
        <div className="card signup-card" style={{ width: "400px" }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              {" "}
              {/* when loading=true button will be disabled and if loading=false then button will be clickable.. this should be done for preventing double clicking */}
        ...
        <div className="illustration-panel d-none d-md-flex flex-column justify-content-between">
          <div className="illustration-text">
            <h1>Welcome back 👋</h1>
            <p>
              Sign in to continue your shopping or manage your store
              effortlessly.
            </p>
          </div>
          ...
          <div className="illustration-graphic">
            <svg viewBox="0 0 260 240" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* person - body */}
              <path
                d="M165 100 q15 -8 30 0 l10 55 q-25 12 -50 0 z"
                fill="#ffffff"
              />
              ...
              <path
                d="M166 76 q17 -18 34 0 q0 -20 -17 -20 t-17 20 z"
                fill="#5b3a29"
              />

              {/* sparkle accents */}
              <path
                d="M215 70 l3 8 8 3 -8 3 -3 8 -3 -8 -8 -3 8 -3 z"
