...
public interface FinancialService {
    PlatformSetting getLatestCommission();

    PlatformSetting createGlobalCommission(@Valid AdminCommissionRequestDTO commissionRequestDTO, User adminUser);

    Page<SellerPayout> getAllPayouts(PaymentStatus status, Pageable pageable);

    SellerPayout releaseSellerPayout(Long sellerId, User adminUser);
